...
## ⛳ Pub Golf mode
Pub Golf now has the **same navigation as crawls** — the course draws a real road route with a **🚶 Walk / 🚗 Drive** toggle, **distance/time**, **🧭 Directions** (turn-by-turn), and a **📍 To this hole** button that opens live GPS navigation to the current hole. You can also **🛠️ Build your own course**: tap **Build your own course** in golf setup (or, from the Crawl Planner, **⛳ Play as Pub Golf**) to make a custom course of any number of holes.
